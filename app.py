...
Design and customize unique avatars with various styles, colors, and accessories. Create your personalized look and download your custom avatar.
---
""")
...
if st.button('Random Avatar'):
    index_skin_color = randrange(len(list_skin_color))
    index_top_type = randrange(len(list_top_type))
    index_hair_color = randrange(len(list_hair_color))
    index_hat_color = randrange(len(list_hat_color))
    index_facial_hair_type = randrange(len(list_facial_hair_type))
    index_facial_hair_color = randrange(len(list_facial_hair_color))
    index_mouth_type = randrange(len(list_mouth_type))
    index_eye_type = randrange(len(list_eye_type))
    index_eyebrow_type = randrange(len(list_eyebrow_type))
    index_accessories_type = randrange(len(list_accessories_type))
    index_clothe_type = randrange(len(list_clothe_type))
    index_clothe_color = randrange(len(list_clothe_color))
    index_clothe_graphic_type = randrange(len(list_clothe_graphic_type))
else:
    index_skin_color = index_top_type = index_hair_color = index_hat_color = 0
    index_facial_hair_type = index_facial_hair_color = index_mouth_type = index_eye_type = 0
    index_eyebrow_type = index_accessories_type = index_clothe_type = index_clothe_color = 0
